                ...
                .then((result) => {
                    ...
                    let skills = [
                        ...
                        },
                        {
                            ...
                            vname: 'Hướng dẫn bài tập về nhà',
                            active: true,
                            point: 1,
                        },
                        {
                            name: 'SICK_CHILD_CARE',
                            vname: 'Chăm trẻ ốm',
                            active: true,
                            point: 1,
                        },
                    ...
                    let sitterSkills = [
                        ...
                        { sitterId: sitters[0].userId, skillId: 3 },
                        { sitterId: sitters[0].userId, skillId: 4 },
                        { sitterId: sitters[0].userId, skillId: 5 },
                        { sitterId: sitters[0].userId, skillId: 6 },
                        { sitterId: sitters[0].userId, skillId: 7 },
                        { sitterId: sitters[0].userId, skillId: 8 },

                        { sitterId: sitters[1].userId, skillId: 2 },
                        { sitterId: sitters[1].userId, skillId: 1 },
                        { sitterId: sitters[1].userId, skillId: 7 },

                        { sitterId: sitters[2].userId, skillId: 4 },
                        { sitterId: sitters[2].userId, skillId: 1 },
                        { sitterId: sitters[2].userId, skillId: 3 },

                        { sitterId: sitters[3].userId, skillId: 5 },
